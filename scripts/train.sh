...
torchrun --nproc_per_node=4 train.py \
    --train_dataset "5_000 @ Scannetpp(split='train', ROOT='data/scannetpp_processed', aug_crop=16, resolution=(256, 256)) + 5_000 @ Scannet(split='train', ROOT='data/scannet_processed', aug_crop=16, resolution=(256, 256))" \
